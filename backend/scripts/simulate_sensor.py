...
DEVICE_ID = os.getenv("DEVICE_ID", "AG-001")
SENSOR_LOCATION = os.getenv("SENSOR_LOCATION", "Amazon-Brazil")
RANGER_PHONE_NUMBER = os.getenv("RANGER_PHONE_NUMBER", "+1234567890")  # Replace with actual ranger number
...
TWILIO_PHONE_NUMBER = os.getenv("TWILIO_PHONE_NUMBER", "+1234567890")  # Your Twilio phone number

# Fixed sensor location (update with actual coordinates)
SENSOR_LATITUDE = float(os.getenv("SENSOR_LATITUDE", "-3.4653"))
SENSOR_LONGITUDE = float(os.getenv("SENSOR_LONGITUDE", "-62.2159"))
